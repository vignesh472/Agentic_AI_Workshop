        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-center">
            ...
            <button
              ...
              className="px-6 py-2 ml-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition"
            >
              Find Gaps
            </button>
            <button
          ...
          {prereqResult.message ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {prereqResult.retrieved && prereqResult.retrieved.map((prereq, idx) => (
                <div key={idx} className="bg-white dark:bg-gray-800 rounded-lg shadow p-5 border-l-4 border-yellow-400 flex flex-col h-full">
                  <div className="flex items-center mb-2">
