...
export default function AdaptiveAssessModal({ open, onClose, concepts }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="relative bg-white/80 dark:bg-gray-900/80 rounded-3xl shadow-2xl p-0 max-w-xl w-full animate-fadeIn border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            {result && result.questions && (
              <>
                ...
                <div className="bg-blue-50 dark:bg-blue-900 rounded-2xl p-6 shadow flex flex-col gap-4 animate-fadeIn">
                  ...
                  <input
                    type="text"
                    className="w-full p-3 rounded-xl border border-blue-300 text-gray-900 text-base focus:ring-2 focus:ring-blue-400"
        ...
        {step === 3 && (
          <div className="p-8 flex flex-col gap-6 items-center animate-fadeIn">
            ...
            <div className="w-full max-w-md bg-white/70 dark:bg-gray-800/70 rounded-2xl shadow p-6 flex flex-col gap-4">
